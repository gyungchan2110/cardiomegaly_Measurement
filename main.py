...
OriginalImgs = [
                base + "/2k_2k/Imgs/Abnormal/1_AS",
                base + "/2k_2k/Imgs/Abnormal/2_AR",
                base + "/2k_2k/Imgs/Abnormal/3_MS",
                base + "/2k_2k/Imgs/Abnormal/4_MR",
                base + "/2k_2k/Imgs/Abnormal/5_AS+AR",
                base + "/2k_2k/Imgs/Abnormal/6_MS_MR" ]
               

Masks = [
        base + "/Masks/Abnormal/1_AS",
        base + "/Masks/Abnormal/2_AR",
        base + "/Masks/Abnormal/3_MS",
        base + "/Masks/Abnormal/4_MR",
        base + "/Masks/Abnormal/5_AS+AR",
        base + "/Masks/Abnormal/6_MS_MR" ]
...
for i, imgPath in enumerate(OriginalImgs):
    ...
    for filename in os.listdir(imgPath):
        ...
        # f.write(filename + "," + str(m_thorax_x_length) + "," + str(m_rtDistance) + "," + str(m_ltDistance) + "," + str(m_aortic_ratio) + "," + str(m_conus_ratio) + "," + str(m_laa_ratio) + "," + str(m_ltlower_ratio) + "," + str(m_rtlower_ratio) + "," + str(m_rtupper_ratio) + "," + str(m_dao_ratio) + "," + str(m_carinaAngle) + "," + str(m_diaphragmLevel) + "," + str(m_cardiacArea) +"\n" )
        f_writer.writerow(rows)
